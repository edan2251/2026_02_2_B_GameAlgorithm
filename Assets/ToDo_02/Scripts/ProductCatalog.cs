...
namespace AlgoCourse.StudentWork
{
    ...
    {
        //가상 Bucket 수를 5로 정합니다.
        private const int NumberOfBuckets = 5;

        //int Key와 ParcelProductInfo Value를 저장할 Dictionary를 생성합니다.
        ...
        {
            //Dictionary를 비우고 상품 1001~1006을 Register로 등록합니다.
            products.Clear();
        ...
        {
            // 중복 Key는 false를 반환하고 새 상품만 등록합니다.
        ...
        {
            //양수 Hash를 Bucket 수로 나눈 나머지를 반환합니다.
            int hash = GetHash(id);
        ...
        {
            //같은 Bucket을 사용하는 다른 Key가 있는지 검사합니다.
